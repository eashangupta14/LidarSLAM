...
def read_canonical_model(model_name):
  ...
  '''
  #print(os.path.join('../code2/icp_warm_up/data', model_name, 'model.mat'))
  model_fname = os.path.join('../code2/icp_warm_up/data', model_name, 'model.mat')
...
def load_pc(model_name, id):
  ...
  return: numpy array, (N, 3)
  '''
  pc_fname = os.path.join('../code2/icp_warm_up/data', model_name, '%d.npy' % id)
  pc = np.load(pc_fname)
